<?php
	...
	if(isset($_POST['submit'])&&!empty($_POST['submit']))
	{
		...
		$mail1 = pg_escape_string($_POST['email']);
		// $pwd = md5($_POST['pwd']);
		$contact = pg_escape_string($_POST['mobno']);
		$city = pg_escape_string($_POST['city']);
		$address = pg_escape_string($_POST['address']);
	  	$sql = "update public.institute_data set name='$name',email='$mail',mobno='$contact',city='$city',address='$address' where email='$mail'";
            ...
            <div class="row"> 
                ...
                <div class="col-md-5 border-right"> 
                    ...
                    <div class="p-3 py-5"> 
                        ...
                        <div class="row mt-2"> 
                            <div class="col-md-6">
                                <label class="labels">Institute Name</label>
                                <input name="fname" type="text" class="form-control" value="<?php echo "".$_SESSION['name'].""; ?>">
                            </div> 
                            <div class="col-md-6">
                                <label class="labels">Email</label>
                                <input name="lname" type="text" class="form-control" value="<?php echo "".$_SESSION['email'].""; ?>" >
                            </div> 
                        </div> 
                        <div class="row mt-3"> 
                            <div class="col-md-12">
